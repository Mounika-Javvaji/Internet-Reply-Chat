...
HELP = "HELP"
EXIT = "EXIT"
HELP_MESSAGE = "\n commands \n LOR - list all rooms \n lime roomem + room name - list all members \n cor + room name - create new room \n jor + room name - join the room \n eor + room name - leave the room \n chatmsg + room name + message - send given message to given room \n help - to see help \n exit - to exit \n"